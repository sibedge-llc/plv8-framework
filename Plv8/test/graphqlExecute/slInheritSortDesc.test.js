...
test('Graphql query with inherit sorting test', () =>
{
    ...
    expect(items[3].company.name).toBe("Appliances");
    expect(items[2].company.name).toBe("Appliances");
    expect(items[1].company.name).toBe("Fruits");
    expect(items[0].company.name).toBe("Sales");
